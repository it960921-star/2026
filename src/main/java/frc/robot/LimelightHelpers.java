...
public class LimelightHelpers {
    ...
    public static double getDistanceToTarget(double d, double e, double f, double ty) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getDistanceToTarget'");
    }
}